Dialogue(
    ...
    sections=[
        DialogueSection(
            'help_beer',
            "Well, good luck with that.  But I'm a little too close to Jake to help out.  You understand, right?",
            responses=[
                DialogueResponse(
                    'Oh, sure, I get it.',
                    'back',
        ...
        DialogueSection(
            'help_fedex',
            "Pekko?  He's in here all the time.  I guess it has been a couple days since I've seen him.",
            responses=[
                DialogueResponse(
        ...
        DialogueSection(
            'gratitude',
            "Huh.  Well, how about that.  You won't forget your friend Kandi when you are famous, right?",
            responses=[
                DialogueResponse(
                    'No way, babe.',
                    'main_dialog',
